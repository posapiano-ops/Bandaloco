...
class Charitable_EventDriven {
	...
	private function get_notifications() {
		...
		return [
			'welcome-message'        => [
				'id'        => 'welcome-message',
				'title'     => esc_html__( 'Welcome to WPForms!', 'charitable-lite' ),
				'content'   => esc_html__( 'We’re grateful that you chose WPForms for your website! Now that you’ve installed the plugin, you’re less than 5 minutes away from publishing your first form. To make it easy, we’ve got 400+ form templates to get you started!', 'charitable-lite' ),
				'btns'      => [
					'main' => [
						'url'  => admin_url( 'admin.php?page=charitable-builder' ),
						'text' => esc_html__( 'Start Building', 'charitable-lite' ),
					],
					'alt'  => [
						...
						'text' => esc_html__( 'Read the Guide', 'charitable-lite' ),
					],
				],
				'type'      => [
					'lite',
			...
			'wp-mail-smtp-education' => [
				...
				'title'     => esc_html__( 'Don’t Miss Your Form Notification Emails!', 'charitable-lite' ),
				'content'   => esc_html__( 'Did you know that many WordPress sites are not properly configured to send emails? With the free WP Mail SMTP plugin, you can easily optimize your site to send emails, avoid the spam folder, and make sure your emails land in the recipient’s inbox every time.', 'charitable-lite' ),
				'btns'      => [
					'main' => [
						'url'  => admin_url( 'admin.php?page=charitable-smtp' ),
						'text' => esc_html__( 'Install Now', 'charitable-lite' ),
					],
					'alt'  => [
						'url'  => $this->add_query_arg(
						...
						'text' => esc_html__( 'Learn More', 'charitable-lite' ),
					],
				],
			...
			'join-vip-circle'        => [
				'id'      => 'join-vip-circle',
				'title'   => esc_html__( 'Want to Be a VIP? Join Now!', 'charitable-lite' ),
				'content' => esc_html__( 'Running a WordPress site can be challenging. But help is just around the corner! Our Facebook group contains tons of tips and help to get your business growing! When you join our VIP Circle, you’ll get instant access to tips, tricks, and answers from a community of loyal WPForms users. Best of all, membership is 100% free!', 'charitable-lite' ),
				'btns'    => [
					'main' => [
						'url'  => 'https://www.facebook.com/groups/charitablevip/',
						'text' => esc_html__( 'Join Now', 'charitable-lite' ),
					],
				],
			...
			'survey-reports'         => [
				'id'        => 'survey-reports',
				'title'     => esc_html__( 'Want to Know What Your Customers Really Think?', 'charitable-lite' ),
				'content'   => esc_html__( 'Nothing beats real feedback from your customers and visitors. That’s why many small businesses love our awesome Surveys and Polls addon. Instantly unlock full survey reporting right in your WordPress dashboard. And don’t forget: building a survey is easy with our pre-made templates, so you could get started within a few minutes!', 'charitable-lite' ),
				'btns'      => [
					'main' => [
						'license' => [
							'lite'  => [
								...
								'text' => esc_html__( 'Upgrade Now', 'charitable-lite' ),
							],
							'basic' => [
								'url'  => $this->add_query_arg(
			...
			'form-abandonment'       => [
				'id'        => 'form-abandonment',
				'title'     => esc_html__( 'Get More Leads From Your Forms!', 'charitable-lite' ),
			...
			'translation-community'  => [
				...
				'title'     => esc_html__( 'WPForms Needs Your Translation Skills!', 'charitable-lite' ),
				'content'   => esc_html__( 'Did you know that WPForms has its own Translation Community? We’re on the lookout for skilled translators to help make WPForms truly accessible to our millions of users around the world. You can earn WPForms swag and a free Pro license. Want to get involved?', 'charitable-lite' ),
				'btns'      => [
					'main' => [
			...
			'ideas'                  => [
				'id'        => 'ideas',
				'title'     => esc_html__( 'What’s Your Dream WPForms Feature?', 'charitable-lite' ),
				'content'   => esc_html__( 'If you could add just one feature to WPForms, what would it be? We want to know! Our team is busy surveying valued customers like you as we plan the year ahead. We’d love to know which features would take your business to the next level! Do you have a second to share your idea with us?', 'charitable-lite' ),
				'btns'      => [
					'main' => [
						'url'  => 'https://wpcharitable.com/share-your-idea/',
						'text' => esc_html__( 'Share Your Idea', 'charitable-lite' ),
					],
				],
