...
?>
<a href="#charitable-donations-filter-modal" class="charitable-filter-button button dashicons-before dashicons-filter trigger-modal hide-if-no-js" data-trigger-modal><?php _e( 'Filter', 'charitable' ); ?></a>
