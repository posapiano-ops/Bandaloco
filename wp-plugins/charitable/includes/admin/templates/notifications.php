...
<div id="charitable-notifications">
	<div class="charitable-notifications-header">
		...
		<div class="charitable-notifications-title"><?php esc_html_e( 'Notifications', 'charitable-lite' ); ?></div>
	</div>
	...
	<div class="charitable-notifications-body">
        ...
        <?php /* <a class="dismiss" title="<?php esc_attr_e( 'Dismiss this message', 'charitable-lite' ); ?>"><i class="fa fa-times-circle" aria-hidden="true"></i></a> */ ?>

		<?php if ( (int) $notifications['count'] > 1 ) : ?>
			<div class="navigation">
				<a class="prev">
					<span class="screen-reader-text"><?php esc_attr_e( 'Previous message', 'charitable-lite' ); ?></span>
					<span aria-hidden="true">&lsaquo;</span>
				</a>
				<a class="next">
					<span class="screen-reader-text"><?php esc_attr_e( 'Next message', 'charitable-lite' ); ?></span>
