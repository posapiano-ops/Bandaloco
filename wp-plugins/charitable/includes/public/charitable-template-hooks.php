...
/* Newly added filters in 1.7.0.9. for campaign page settings */
add_filter( 'charitable_display_template_campaign_percentage_raised', 'charitable_maybe_hide_campaign_percentage_raised', 4, 2 );
add_filter( 'charitable_display_template_campaign_donor_count', 'charitable_maybe_hide_campaign_donor_count', 4, 2 );
add_filter( 'charitable_donation_summary', 'charitable_maybe_hide_campaign_amount_donated', 20, 4 );
add_filter( 'charitable_display_template_campaign_time_remaining', 'charitable_maybe_hide_campaign_time_remaining', 4, 2 );
