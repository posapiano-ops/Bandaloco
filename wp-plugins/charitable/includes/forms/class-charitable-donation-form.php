	...
	class Charitable_Donation_Form extends Charitable_Form implements Charitable_Donation_Form_Interface {
		...
		public function minimum_donation_amount_notice( $return = true, $minimum_amount = false ) {
			...
			if ( false === $minimum_amount || '' === trim( $minimum_amount ) ) {
				...
				$message = '<p class="minimum-donation-amount-text">' . __( 'The minimum donation for this campaign is ', 'charitable' ) . charitable_format_money( $minimum_amount, false, true ) . '.</p>';
			}
