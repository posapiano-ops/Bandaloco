...
if ( count( $suggested ) ) :
	...
	<ul class="donation-amounts">
		...
		foreach ( $suggested as $suggestion ) :
			...
			if ( false === $checked_once && trim( htmlentities( $default ) ) === trim( html_entity_decode( charitable_format_money( $suggestion['amount'], false, true ) ) ) || trim( htmlentities( $default ) ) === trim( html_entity_decode( $suggestion['amount'] ) ) ) :
