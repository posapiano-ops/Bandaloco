        ...
        <?php if ($topmenu != '') {
            ...
            <?php if (isset($borntogive_options['header_info_1_text']) && $borntogive_options['header_info_1_text'] != '') { ?>
                <div class="header-info-col">
                    <?php if ($borntogive_options['header_info_1_icon'] != '') { ?><i class="fa <?php echo esc_attr($borntogive_options['header_info_1_icon']); ?>"></i><?php } ?> <strong><?php echo '' . ($borntogive_options['header_info_1_text']); ?></strong>
                </div>
            <?php }
        if (isset($borntogive_options['header_info_2_text']) && $borntogive_options['header_info_2_text'] != '') { ?>
                <div class="header-info-col">
                    <?php if ($borntogive_options['header_info_2_icon'] != '') { ?><i class="fa <?php echo esc_attr($borntogive_options['header_info_2_icon']); ?>"></i><?php } ?> <strong><?php echo '' . ($borntogive_options['header_info_2_text']); ?></strong>
                </div>
            <?php }
    } ?>
    </div>
