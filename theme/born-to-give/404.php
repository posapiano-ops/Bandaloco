				...
				<div class="col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2">
					...
					<article class="page-404">
						<div class="text-align-center">
							...
							<?php esc_html_e('The page you are looking for was moved, removed, renamed', 'borntogive'); ?><br>
							<?php esc_html_e('or might never existed. You stumbled upon a broken link', 'borntogive');
							echo ':('; ?>
						</div>
					</article>
				</div>
