 jQuery(function($){
    ...
    jQuery('#upload_category_button_remove').on('click', function() {
        jQuery('#upload_image_preview').attr('src','');
        jQuery('#category_url').val('');
        jQuery('#upload_image_preview').hide();
    })
    jQuery('#upload_category_button').on('click', function() {
...
jQuery(function($){
    ...
    jQuery('#upload_term_button_remove').on('click', function() {
		jQuery('#banner_image_preview').attr('src','');
        jQuery('#term_url').val('');
        jQuery('#banner_image_preview').hide();
    });
    jQuery('#upload_term_button').on('click', function() {
        var fileFrame = wp.media.frames.file_frame = wp.media({
            multiple: false
        });
        fileFrame.on('select', function() {
