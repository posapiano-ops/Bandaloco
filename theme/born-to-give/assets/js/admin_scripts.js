(function ($) {
    ...
    jQuery(function ($) {
        ...
        jQuery('body').on('click','#upload_agent_button_remove', function () {
            jQuery('#upload_image_preview').attr('src', '');
            jQuery('#agent_url').val('');
            jQuery('#upload_image_preview').hide();
        })
        jQuery('body').on('click','#upload_agent_button', function () {
    ...
    $(document).ready(function () {
        var mb = jQuery('#btg-admin-notices'),
            mbl = mb.length;
        ...
        jQuery("body").on('click','#team_meta_box', '#Social', function () {
            //alert("saibaba");
        ...
        jQuery("label[for='imic_social_icon_list']").on('click',function (e) {
            e.preventDefault();
        });
    });
    jQuery('.redux-message').hide();
    jQuery('#meta-box-notification').hide();
})(jQuery);