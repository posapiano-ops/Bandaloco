...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $current_object_id = 0)
    {
        ...
        if (!empty($item->_invalid)) {
            ...
            $title = sprintf(esc_html__('%s (Invalid)', 'borntogive'), $item->title);
        } elseif (isset($item->post_status) && 'draft' == $item->post_status) {
            $classes[] = 'pending';
            /* translators: %s: title of menu item in draft status */
            $title = sprintf(esc_html__('%s (Pending)', 'borntogive'), $item->title);
        }
                    ...
                    <div class="enabled_mega_data">
                        ...
                        <p class="field-custom description description-wide">
                            <label for="edit-menu-post-<?php echo esc_attr($item_id); ?>">
                                <?php esc_html_e('Enter Number of Post Ex-3', 'borntogive'); ?><input type="text" id="edit-menu-post-<?php echo esc_attr($item_id); ?>" class="menu-post edit-menu-item-custom" name="menu-post[<?php echo esc_attr($item_id); ?>]" value="<?php echo borntogive_allowed_tags_kses::strip_tags($item->menupost); ?>" />
                            </label>
                        </p>
                        <p class="field-custom description description-wide">
                            <label for="edit-menu-post-id-comma-<?php echo esc_attr($item_id); ?>">
                                <?php esc_html_e('Enter Comma seperated value Ex-1,2,3(for  menu use M like M10)', 'borntogive'); ?><input type="text" id="edit-menu-post-id-comma-<?php echo esc_attr($item_id); ?>" class="menu-post-id-comma edit-menu-item-custom" name="menu-post-id-comma[<?php echo esc_attr($item_id); ?>]" value="<?php echo borntogive_allowed_tags_kses::strip_tags($item->menupostidcomma); ?>" />
                            </label>
                        </p>
                        <p class="field-custom description description-wide">
                            <label for="edit-menu-shortcode-<?php echo esc_attr($item_id); ?>">
                                <?php esc_html_e('Textarea may be used as Text Editor', 'borntogive'); ?>
                                <textarea id="edit-menu-shortcode-<?php echo esc_attr($item_id); ?>" class="edit-menu-item-custom" style="margin: 2px; width: 396px; height: 92px;" name="menu-shortcode[<?php echo esc_attr($item_id); ?>]" /><?php echo borntogive_allowed_tags_kses::strip_tags($item->menushortcode); ?></textarea>
            ...
            <div class="menu-item-actions description-wide submitbox">
                <?php if ('custom' != $item->type && $original_title !== false) : ?>
                    <p class="link-to-original">
                        <?php printf(esc_html__('Original: %s', 'borntogive'), '<a href="' . esc_attr($item->url) . '">' . esc_html($original_title) . '</a>'); ?>
                    </p>
                <?php endif; ?>
