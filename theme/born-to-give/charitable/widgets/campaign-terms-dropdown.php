...
$dropdown_args = array(
	...
	'id'               => $dropdown_id,
	'show_option_none' => sprintf(_x('Select %s', 'select campaign category/tag', 'borntogive'), ucwords(str_replace('_', ' ', $taxonomy))),
	'value_field'      => 'slug',
	'selected'         => is_tax($taxonomy) ? get_query_var($taxonomy) : 0,
);

echo borntogive_allowed_tags_kses::strip_tags($view_args['before_widget']);
