...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
		...
		<script language="javascript" type="text/javascript" src="<?php echo plugin_dir_url( __FILE__ ); ?>imic.shortcode.embed.js?v=1.7"></script>
                ...
                <div id="shortcode_panel" class="current">
                    <fieldset>
                        ...
                        <div id="shortcode-calendar">
							...
							<div class="option">
								<label for="category_id"><?php esc_html_e('Event Category', 'imithemes-shortcodes'); ?></label>
								<select id="category_id" name="category_id">
								<option value=""><?php esc_html_e('Select', 'imithemes-shortcodes'); ?></option>
								<?php
