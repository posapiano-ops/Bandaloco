...
if ( ! class_exists( 'Charitable_Forgot_Password_Endpoint' ) ) :
	...
	class Charitable_Forgot_Password_Endpoint extends Charitable_Endpoint {
		...
		public function uses_custom_template() {
			return ! charitable_is_block_theme() && 'wp' !== charitable_get_option( 'login_page', 'wp' );
		}
		...
		public function get_template( $template ) {
			return charitable_splice_template(
				get_page_template_slug( charitable_get_option( 'login_page', 'wp' ) ),
				array( 'forgot-password-page.php', 'page.php', 'singular.php', 'index.php' )
			);
		}
