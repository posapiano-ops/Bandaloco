...
if ( ! class_exists( 'Charitable_User' ) ) :
	...
	class Charitable_User extends WP_User {
		 ...
		 * @return string
		 */
		public function get_avatar( $size = 100, $donor_id = false ) {
			/**If you use this filter, return an attachment ID. */

			$avatar_attachment_id = get_user_meta( $this->ID, 'avatar', true );

			$avatar_attachment_id = apply_filters( 'charitable_user_avatar', $avatar_attachment_id, $this );
