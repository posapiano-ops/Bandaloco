<?php
/**
 * Charitable navigation menu walker.
 *
 * @package   Charitable/Classes/Charitable_Nav_Menu_Walker
 * @author    David Bisset
...
/**
 * Create a set of Charitable-specific links for use in the Menus admin UI.
 *
 ...
 * @since 1.9.0
 */
class Charitable_Walker_Nav_Menu_Checklist extends Walker_Nav_Menu {
