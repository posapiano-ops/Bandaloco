 ...
 */
add_filter( 'charitable_settings_tab_fields_tools', array( Charitable_Tools_Settings::get_instance(), 'add_tools_fields' ), 5 );
...
/**
 * Preform any tasks when the advannced tab is saved.
 *
 ...
 * @see Charitable_Advanced_Settings::add_advanced_fields()
 */
add_filter( 'charitable_addons_directory_settings_page_start', array( Charitable_Addons_Directory::get_instance(), 'test' ), 5 );