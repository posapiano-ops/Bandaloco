/* global charitable_admin, WPCharitableAdmin */

/**
 * WPCharitable Admin Notifications.
 *
 * @since 1.6.0
 */
 ...
 var WPCharitableAdminNotifications = window.WPCharitableAdminNotifications || ( function( document, window, $ ) {

    $('#charitable-notifications').insertAfter( $( '.wp-header-end' ) );
     ...
     var el = {
         ...
         $notifications:    $( '#charitable-notifications' ),
         $nextButton:       $( '#charitable-notifications .navigation .next' ),
         $prevButton:       $( '#charitable-notifications .navigation .prev' ),
         $adminBarCounter:  $( '#wp-admin-bar-charitable-menu .charitable-menu-notification-counter' ),
         $adminBarMenuItem: $( '#wp-admin-bar-charitable-notifications' ),
     ...
     var app = {
         ...
         dismiss: function( event ) {
             ...
             $.post( charitable_admin.ajax_url, data, function( res ) {
                 ...
                 if ( ! res.success ) {
                     // WPCharitableAdmin.debug( res );
                     console.log( res );
                 }
             } ).fail( function( xhr, textStatus, e ) {

                //  WPCharitableAdmin.debug( xhr.responseText );
         ...
         updateNavigation: function() {
             ...
             el.$currentMessage = el.$notifications.find( '.charitable-notifications-message.current' );
             el.$nextMessage = el.$currentMessage.next( '.charitable-notifications-message' );
             el.$prevMessage = el.$currentMessage.prev( '.charitable-notifications-message' );
 ...
 // Initialize.
 WPCharitableAdminNotifications.init();
